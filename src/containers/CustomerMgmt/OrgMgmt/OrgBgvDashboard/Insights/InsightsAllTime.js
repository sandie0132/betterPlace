                                        ...
                                        <React.Fragment>
                                            ...
                                            {bgvData["missingDetails"]["totalMissingInfoCount"] !== 0 ?
                                                <React.Fragment>
                                                    ...
                                                    {t('translation_orgBgvStatus:missingInfo')} </div>
                                                    <div className={cx("row ml-0 mt-3", styles.cardBg)}>
                                                        ...
                                                        <div className="mx-5" style={{ color: "#212529" }}>
                                                            <div className="d-flex" >
                                                                <div className={styles.smallCardHeading}>{bgvData["missingDetails"]["BgvMissingInfoNotification"]} </div><div className={styles.smallCardTextBold}>&nbsp;&nbsp;{t('translation_orgBgvStatus:profiles')}</div></div>
                                                            <div className={cx(styles.smallCardText, "mt-2")}>{t('translation_orgBgvStatus:bgvMissing')}</div>
                                                        </div>
                                                        <div className="mx-4" style={{ color: "#8697A8" }}>
                                                            <div className="d-flex" >
                                                                <div className={styles.smallCardHeading}>{bgvData["missingDetails"]["BgvInsufficientInfoNotification"]} </div> <div className={styles.smallCardText}>&nbsp;&nbsp;{t('translation_orgBgvStatus:profiles')}</div></div>
                                                            <div className={cx(styles.smallCardText, "mt-2")}>{t('translation_orgBgvStatus:bgvInsuff')}</div>
                                                        </div>
                                            ...
                                            {bgvData["approvalDetails"]["totalApprovalInfoCount"] !== 0 ?
                                                <React.Fragment>
                                                    <div className={styles.heading}>
                                                    {t('translation_orgBgvStatus:reinitiate')}<span className={styles.headingBold}>&nbsp;&nbsp;{bgvData["approvalDetails"]["totalApprovalInfoCount"]}&nbsp;&nbsp;</span>{t('translation_orgBgvStatus:checks')}</div>
                                                    <div className={cx("row ml-0 mt-3", styles.cardBg)}>
                                                        <div className="ml-3">
                                                        ...
                                                        <div className="mx-5" style={{ color: "#212529" }}>
                                                            <div className="d-flex" >
                                                                <div className={styles.smallCardHeading}>{bgvData["approvalDetails"]["EmpDetailsUpdateApprovalNotification"]}</div> <div className={styles.smallCardTextBold}>&nbsp;&nbsp;{t('translation_orgBgvStatus:checks')}</div></div>
                                                            <div className={cx(styles.smallCardText, "mt-2")}>{t('translation_orgBgvStatus:empDet')}</div>
                                                        </div>
                                                        <div className="mx-4" style={{ color: "#8697A8" }}>
                                                            <div className="d-flex" >
                                                                <div className={styles.smallCardHeading}>{bgvData["approvalDetails"]["BgvVerificationApprovalNotification"]}</div> <div className={styles.smallCardText}>&nbsp;&nbsp;{t('translation_orgBgvStatus:checks')}</div></div>
                                                            <div className={cx(styles.smallCardText, "mt-2")}>{t('translation_orgBgvStatus:bgvApproval')}</div>
                                                        </div>
                                                        {/* <div className="ml-auto">
                                                    <span className={styles.downloadButton} onClick={() => this.downloadxlxsPOC()}>
                                                        donwload approvals
                                            ...
                                            {bgvData.totalOnboardedCount !== 0 ?
                                                <React.Fragment>
                                                    <div className={styles.heading}>{t('translation_orgBgvStatus:terminatedProfiles')}</div>
                                                    <div className={cx("row ml-0 mt-3", styles.cardBgSmall)}>
                                                        ...
                                                        <div className="d-flex" >
                                                            <div className={styles.smallCardHeading}>400</div> <div className={styles.smallCardText}>&nbsp;&nbsp;{t('translation_orgBgvStatus:employees')}</div></div>
                                                        <div className={cx(styles.smallCardText, "mt-2")}>over all terminated ( till now )</div>
                                                    </div> */}
                                                            <div className="mx-4" style={{ color: "#8697A8" }}>
                                                                <div className="d-flex" >
                                                                    <div className={styles.smallCardHeading}>{bgvData.totalOnboardedCount}</div> <div className={styles.smallCardText}>&nbsp;&nbsp;{t('translation_orgBgvStatus:employees')}</div></div>
                                                                <div className={cx(styles.smallCardText, "mt-2")}>{t('translation_orgBgvStatus:onboardedOverall')}</div>
                                                            </div>
