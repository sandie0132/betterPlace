...
import esicBuilding from "../../../../../../assets/icons/esicBg.svg";
...
class ESIC extends Component {
    ...
    handlePropsToState = () => {
        ...
        if (!_.isEmpty(configData)) {
            let esicData = configData.documents.find((doc) => {
                return doc.documentType === "ESIC"
            })
            
            if (!_.isEmpty(esicData.userName) && !_.isEmpty(esicData.password)) {
                prevFormData["userName"] = esicData.userName
                prevFormData["password"] = esicData.password  
            }
        }
        this.setState({
    ...
    handleProcess = () => {
        ...
        this.props.onProcessDocument(orgId, "ESIC", payload);
    }
                ...
                if (!_.isEmpty(this.props.configData)) {
                    ...
                    if (!_.isEmpty(configDataArray)) {
                        ...
                        if (this.state.isEdited) {
                            ...
                            let esicData = configDataArray.find((doc) => {
                                return doc.documentType === "ESIC"
                            })
                            if (!_.isEmpty(esicData.password) && !_.isEmpty(esicData.userName)) {
                                return "done"
                            } else {
                                return "enable"
                            }
            ...
            <React.Fragment>
                ...
                <div className={cx(styles.alignCenter, scrollStyle.scrollbar)}>
                    ...
                    <div className={styles.positionHeading}>
                        ...
                        />
                        <CardHeader label={"document management - employee state insurance corporation"} iconSrc={container} />
                            ...
                            <div className="row no-gutters">
                                ...
                                <div className="col-6 p-4" >
                                    ...
                                    <div className={cx(styles.textCenter, "mt-3")}>
                                        <img src={esicBuilding} alt="esic" />
                                    </div>
                                    <div className={styles.websiteBox}>
                                        <div className={styles.inlineBlock}>
                                            <div className={styles.headingBoldBlack}>visit website</div>
                                            <a className={styles.textSmall} target="_blank" href="https://www.esic.nic.in/" rel="noopener noreferrer">
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(ESIC));