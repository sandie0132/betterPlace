...
export const validation = {
    documentNumber: {
        ...
        validDocumentNumber: value  => _.isEmpty(value) || /^[a-zA-Z]{3}\d{7}$/.test(value)
    },
    dob: {
...
export const message = {
    documentNumber:{
        totalLength: 'voter number must be 10 character long',
        validDocumentNumber: 'enter a valid voter id number'
    },
    dob: {
