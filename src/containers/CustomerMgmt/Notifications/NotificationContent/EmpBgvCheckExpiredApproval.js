...
const EmpBgvCheckExpiredApproval = (props) => {

    return (
        <div className={cx(styles.background, "row mx-0 px-0")}>
            <div>
                <img src={illustrator} className={styles.illustrator} style={{ top: "1.5rem" }} alt='' />
            </div>
            ...
            <React.Fragment>
                <div  style={{width:'45%'}}>
                    ...
                    <div className={cx(styles.textNormal, "mt-2")}>
                        {props.data.data.empIds.length} employees verification items have been expired and need approval for re-initiation
                     </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(EmpBgvCheckExpiredApproval);